...
For a private bucket, you can configure Next.js S3 Uploader to generate pre-signed URLs for secure access to files. We'll cover this in more detail in the [API Route](/docs/api-route) section.
...
```javascript {7} filename="app/api/s3-upload.js"
